...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=x86_64 --cc='xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch x86_64 -mios-simulator-version-min=6.0' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=6.0' --prefix=/Users/yangyixin/Documents/FFmpeg/FFmpeg-iOS-build-script-master/thin/x86_64
prefix=/Users/yangyixin/Documents/FFmpeg/FFmpeg-iOS-build-script-master/thin/x86_64
