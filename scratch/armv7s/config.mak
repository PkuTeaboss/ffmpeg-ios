...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=armv7s --cc='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --extra-cflags='-arch armv7s -mios-version-min=6.0' --extra-ldflags='-arch armv7s -mios-version-min=6.0' --prefix=/Users/yangyixin/Documents/FFmpeg/FFmpeg-iOS-build-script-master/thin/armv7s
...
CFLAGS=  -arch armv7s -mios-version-min=6.0 -march=armv7-a -std=c99 -fomit-frame-pointer -fPIC -mthumb -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -arch armv7s -mios-version-min=6.0 -march=armv7-a -fPIC -Qunused-arguments
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -arch armv7s -mios-version-min=6.0  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDLIBFLAGS=
